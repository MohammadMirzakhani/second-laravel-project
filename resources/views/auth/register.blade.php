            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="phone" class="col-md-4 col-form-label text-md-end">{{ __('تلفن همراه') }}</label>
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <a href="{{ route('verification.notice') }}" class="btn btn-outline-success">فعالسازی ایمیل </a>
                            </div>
                        </div>
                    </form>
                </div>
